...
#user_info <- fromJSON(getURL(paste('https://api.instagram.com/v1/tags/search?q=',tag,'&access_token=',token,sep="")),unexpected.escape = "keep")
...
write.csv(prof, "makeamericagreatagain_posts.csv")
write.csv(us_liked, "makeamericagreatagain_likes.csv")
write.csv(us_tagged, "makeamericagreatagain_tags.csv")
write.csv(comments, "makeamericagreatagain_comments.csv")
